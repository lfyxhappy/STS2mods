...
public sealed class WishLiveForever : WatcherCard
{
	...
	protected override IEnumerable<DynamicVar> CanonicalVars => new global::_003C_003Ez__ReadOnlySingleElementList<DynamicVar>(new DynamicVar("MagicNumber", 6m));

	public WishLiveForever()
