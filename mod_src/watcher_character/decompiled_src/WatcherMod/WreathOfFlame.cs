...
public sealed class WreathOfFlame : WatcherCard
{
	...
	{
		await PowerCmd.Apply<VigorPower>(base.Owner.Creature, base.DynamicVars["MagicNumber"].BaseValue, base.Owner.Creature, this);
	}
