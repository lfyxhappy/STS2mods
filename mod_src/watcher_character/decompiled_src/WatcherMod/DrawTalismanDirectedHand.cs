...
public sealed class DrawTalismanDirectedHand : WatcherCard
{
	public override CardPoolModel Pool => ModelDb.CardPool<ColorlessCardPool>();

	public override string PortraitPath => "res://images/packed/card_portraits/watcher/drawtalisman.png";
	...
	public DrawTalismanDirectedHand()
