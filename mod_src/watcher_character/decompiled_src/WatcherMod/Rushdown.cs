...
public sealed class Rushdown : WatcherCard
{
	protected override IEnumerable<IHoverTip> ExtraHoverTips => new global::_003C_003Ez__ReadOnlyArray<IHoverTip>(new IHoverTip[3]
	{
		...
		HoverTipFactory.FromPower<RushdownPower>()
	});
	...
	{
		await PowerCmd.Apply<RushdownPower>(base.Owner.Creature, base.DynamicVars["MagicNumber"].BaseValue, base.Owner.Creature, this);
	}
